...
from networks.UNet_layers import unetConv2
from networks.UNet_init_weights import init_weights
import numpy as np
...
class UNet_3Plus_sfam(nn.Module):

    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True):
        super(UNet_3Plus_sfam, self).__init__()
        ...
        self.se1 = SELayer(filters[1])
        self.se2 = SELayer(filters[2])
        self.se3 = SELayer(filters[3])
        self.se4 = SELayer(filters[4])
...
class UNet_3Plus_DeepSup_CGM(nn.Module):
    ...
    def forward(self, inputs):
        ...
        hd5_UT_hd4 = self.hd5_UT_hd4_relu(self.hd5_UT_hd4_bn(self.hd5_UT_hd4_conv(self.hd5_UT_hd4(hd5))))
        hd4 = self.relu4d_1(self.bn4d_1(self.conv4d_1(
            torch.cat(self.sfam[h1_PT_hd4, h2_PT_hd4, h3_PT_hd4, h4_Cat_hd4, hd5_UT_hd4], 1))))  # hd4->40*40*UpChannels
        ...
        hd5_UT_hd3 = self.hd5_UT_hd3_relu(self.hd5_UT_hd3_bn(self.hd5_UT_hd3_conv(self.hd5_UT_hd3(hd5))))
        hd3 = self.relu3d_1(self.bn3d_1(self.conv3d_1(
            torch.cat(self.sfam[h1_PT_hd3, h2_PT_hd3, h3_Cat_hd3, hd4_UT_hd3, hd5_UT_hd3], 1))))  # hd3->80*80*UpChannels
        ...
        hd5_UT_hd2 = self.hd5_UT_hd2_relu(self.hd5_UT_hd2_bn(self.hd5_UT_hd2_conv(self.hd5_UT_hd2(hd5))))
        hd2 = self.relu2d_1(self.bn2d_1(self.conv2d_1(
            torch.cat(self.sfam[h1_PT_hd2, h2_Cat_hd2, hd3_UT_hd2, hd4_UT_hd2, hd5_UT_hd2], 1))))  # hd2->160*160*UpChannels
        ...
        hd5_UT_hd1 = self.hd5_UT_hd1_relu(self.hd5_UT_hd1_bn(self.hd5_UT_hd1_conv(self.hd5_UT_hd1(hd5))))
        hd1 = self.relu1d_1(self.bn1d_1(self.conv1d_1(
            torch.cat(self.sfam[h1_Cat_hd1, hd2_UT_hd1, hd3_UT_hd1, hd4_UT_hd1, hd5_UT_hd1], 1))))  # hd1->320*320*UpChannels
...
# def test():
#     net = UNet_3Plus(in_channels=3, n_classes=2)
